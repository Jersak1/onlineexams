  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Gid.jpg" width=100 height=100 alt="Akuoko Gideon" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">AKUOKO GIDEON</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">0551 201464</h4>
		<h4 style="font-family:'typo' ">akuokogideon22@gmail.com</h4>
		<h4 style="font-family:'typo' ">Brownian IT Consult</h4></div></div>
		</p>
      </div>
